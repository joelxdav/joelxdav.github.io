  ...
  */
  ...
  function loadWeeklyContent(week) {
    week_content = [
      ...
      '<li><a href="https://codepen.io/joelxdav/pen/RwoyGBY" target="_blank">7.1 - "Hello World!"</a> (Codepen)</li><li><a href="https://codepen.io/joelxdav/pen/zYojKXd" target="_blank">7.2 - Variable name</a> (Codepen)</li>',
      '<li><a href="">8.1</a></li>'
    ];  
